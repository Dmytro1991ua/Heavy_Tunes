...
export const audioPlayerInitialization = () => {
   ...
   const playListArray = ["Hatebreed - Destroy Everything", "Metallica - One", "BFMV - Piece of Me", "Sabaton - Uprising", "Disturbed - The Night", "Powerwolf - Stossgebet", "Rammstein - Deutschland", "Seether - Pride", "Fear Factory - New Messiah"]; // an array of playlist since there is no backend in thsi project
   ...
   const loadTrack = () => {
      ...
      setTimeout(updateAudioProggressBar, 500);
   };
